...
export default function Challenges() {
 ...
 return (
  <div className="relative overflow-hidden max-w-4xl mx-auto p-6 bg-blue-50">
    {/* Floating Background */}
    ...
    {/* Header Section */}
    <motion.h1 
      className="text-5xl font-extrabold mb-6 flex items-center text-green-700 z-10 relative"
    ...
    {/* Description Section */}
    <motion.p 
      className="text-xl text-black mb-8 z-10 relative"
      initial={{ opacity: 0 }} 
      animate={{ opacity: 1 }} 
    ...
    <motion.div 
      ...
      transition={{ duration: 1 }}
    >
      <label className="block text-black mb-2">Enter your name:</label>
      <input
        type="text"
    ...
    {badge && (
      ...
      >
        ...
        <p className="text-5xl text-black">{badge}</p>
      </motion.div>
    )}
